                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="service-content m-t-50">
                            <h3>In Brief</h3>
                            <p>Founded in January of 2020, Tradaxs is a digital currency wallet and platform where
                                merchants
                    ...
                    <div class="col-lg-12">
                        <div class="ceo-content">
                            <div class="d-flex align-items-start">
                                <img src="images/avatar/6.jpg" alt="" class="img-fluid me-4 rounded-circle">
                                <div class="flex-grow-1">
                                    <h3>Eric Benz</h3>
                                    <span>CEO of Tradaxs</span>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="service-content my-5">
                            <h3>Working at Tradaxs</h3>
                            <p>Digital currencies are changing how we use and think about money. Tradaxs, the most
                                trusted
