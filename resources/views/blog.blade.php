                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="blog-grid">
                                <div class="card">
                                    ...
                                    <div class="card-footer">
                                        <div class="meta-info">
                                            <a href="#" class="author"><img src="images/avatar/6.jpg" alt="">
                                                Admin</a>
                                            <a href="#" class="post-date"><i class="la la-calendar"></i> 31 July,
                                                <script>
                                                    var CurrentYear = new Date().getFullYear()
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="blog-grid">
                                <div class="card">
                                    ...
                                    <div class="card-footer">
                                        <div class="meta-info">
                                            <a href="#" class="author"><img src="images/avatar/7.jpg" alt="">
                                                Admin</a>
                                            <a href="#" class="post-date"><i class="la la-calendar"></i> 31 July,
                                                <script>
                                                    var CurrentYear = new Date().getFullYear()
                    ...
                    <div class="blog-sidebar">
                        ...
                        <div class="widget-recent-post">
                            ...
                            <ul class="list-unstyled">
                                <li class="d-flex">
                                    <img src="images/blog/post_1.jpg" class="me-3" alt="...">
                                    <div class="flex-grow-1">
                                        <h5 class="mt-0 mb-1">List-based media object</h5>
                                        <div class="meta-info">
                                            <a href="#"><i class="la la-user"></i> Admin</a>
                                            <a href="#"><i class="la la-calendar"></i> 31 July,
                                                <script>
                                                    var CurrentYear = new Date().getFullYear()
                                                    document.write(CurrentYear)
                                                </script>
                                ...
                                <li class="media my-4">
                                    <img src="images/blog/post_2.jpg" class="me-3" alt="...">
                                    <div class="flex-grow-1">
                                        <h5 class="mt-0 mb-1">List-based media object</h5>
                                        <div class="meta-info">
                                            <a href="#"><i class="la la-user"></i> Admin</a>
                                ...
                                <li class="d-flex">
                                    <img src="images/blog/post_3.jpg" class="me-3" alt="...">
                                    <div class="flex-grow-1">
                                        <h5 class="mt-0 mb-1">List-based media object</h5>
                                        <div class="meta-info">
                                            <a href="#"><i class="la la-user"></i> Admin</a>
