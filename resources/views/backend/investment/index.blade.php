...
<div class="content-body">
    <div class="container p-5 rounded col-9 col-sm-12">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header text-center text-light rounded-lg rounded-top bg-dark">Invest  With Us</div>
                <div class="card-body">
                    <div class="card-title">
                        <h3 class="text-center title-2">Enter Neccessary Details to Invest</h3>
                    </div>
                    <hr>
